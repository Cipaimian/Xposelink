    ...
    >
      ...
      >
        ...
        <div className="w-full px-10 py-5 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-14 absolute left-1/2 -translate-x-1/2">
      ...
      <section
        className="relative w-full flex flex-col items-center justify-center pt-20 pb-36 px-10 z-10 overflow-visible"
        style={{
          background: `
      ...
      >
        ...
        <div className="animate-fade-up text-center w-full relative z-10">
          <h1 className="font-thin tracking-tight text-white/90 leading-[1.08] whitespace-nowrap"
            style={{ fontSize: "clamp(2.8rem, 7.8vw, 13rem)" }}>
            Shorten &amp; Reveal
          </h1>
        ...
        {/* CTAs */}
        <div className="animate-fade-up-delay-2 mt-6 flex items-center gap-4 relative z-10">
          <button onClick={handleTryFree}
            className="btn-shimmer relative overflow-hidden text-white px-8 py-3.5 rounded-2xl font-semibold text-sm border-none cursor-pointer active:scale-95 transition-transform">
            Try it free →
            {ripple && <span className="animate-ripple absolute inset-0 rounded-2xl bg-white/30 pointer-events-none" />}
            </button>
          <button onClick={onSignUpClick}
            className="btn-shimmer text-white px-8 py-3.5 rounded-2xl font-semibold text-sm border-none cursor-pointer active:scale-95">
            Create account
            </button>
        </div>
      ...
      {/* ═══════════════════════ TOOLS ═══════════════════════ */}
      <section id="tools" className="relative w-full py-24 px-10 overflow-visible"
        style={{
          background: "#ffffff",
        ...
        <div className="w-full relative z-10">
          <div className="text-center mb-14">
            ...
            <h2 className="text-5xl font-light text-gray-800 tracking-tight">Two tools, zero friction</h2>
          ...
          {outOfTokens && (
            <div
              className="mb-8 rounded-2xl px-6 py-5 flex items-center justify-between gap-4"
      ...
      {/* ═══════════════════════ EXTENSION ═══════════════════════ */}
      <section id="extension" className="relative flex flex-col items-center px-10 text-center z-10 overflow-visible" style={{ background: "#ffffff", minHeight: "calc(100vh - 72px)", paddingTop: "10px", paddingBottom: "200px", scrollMarginTop: "20px" }}>
        ...
        <div className="relative z-10 w-full max-w-5xl">
          ...
          <h2 className="text-5xl font-light text-gray-800 mb-12 tracking-tight">Browser Extension</h2>
          <div className="flex flex-col md:flex-row items-stretch justify-center gap-6 mb-8">
            <img
              src="/image1.png"
              alt="Xposelink extension popup"
              className="rounded-2xl shadow-lg object-cover"
              style={{ width: "45%", maxWidth: 600, minWidth: 380, border: "1px solid rgba(0,0,0,0.07)" }}
            />
            <img
              src="/image2.png"
          ...
          <p className="text-gray-500 max-w-xl mx-auto leading-relaxed text-xl mt-10">
      ...
      <section id="plans" className="relative flex flex-col items-center px-6 text-center z-10 overflow-visible" style={{ background: "#ffffff", minHeight: "calc(100vh - 72px)", paddingTop: "60px", paddingBottom: "180px", scrollMarginTop: "-60px"}}>
        ...
        <div className="relative z-10 w-full">
          <h2 className="text-5xl font-light text-gray-800 mb-4 tracking-tight">Simple, transparent pricing</h2>
      ...
      {/* ═══════════════════════ Support ═══════════════════════ */}
      <section id="support" className="relative w-full px-10 z-10" style={{ background: "#ffffff", paddingTop: "110px", paddingBottom: "80px", scrollMarginTop: "-135px" }}>
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-5xl font-light text-gray-800 tracking-tight">Got questions?</h2>
      ...
      {/* ═══════════════════════ FOOTER ═══════════════════════ */}
      <footer
        className="w-full py-4 px-10 flex items-center justify-between z-10"
        style={{ background: "linear-gradient(135deg, #0f172a 0%, #1a2d5a 100%)" }}
      >
        <XposeLogo size="sm" />
        <p className="text-white/30 text-xs">© {new Date().getFullYear()} Xposelink. All rights reserved.</p>
