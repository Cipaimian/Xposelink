...
export default function Dashboard({ currentUser, onLogout }) {
        ...
        {myLinksLoading ? (
          ...
          <div className="flex flex-col" style={{ gap: 0 }}>
            {myLinks.map((link) => {
              ...
              return (
                <div key={link.id} className="flex items-start gap-4 py-4"
  ...
  return (
    <div className="min-h-screen flex" style={{ background: "#0f172a" }}>
      ...
      {/* ── Main content ── */}
      <main className="flex flex-col flex-1 min-h-screen" style={{ marginLeft: 220 }}>
        {/* Top bar */}
        <header
        ...
        >
          <h2 className="text-white/70 text-sm font-medium capitalize">
